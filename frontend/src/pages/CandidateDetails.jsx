    ...
    <div className="space-y-3 animate-in fade-in duration-300">
      ...
      {candidate.analysisStatus === 'rejected' && (
        <div className="p-3 text-xs rounded-xl border bg-amber-500/10 border-amber-500/20 text-amber-700 dark:text-amber-400 flex items-start gap-2">
          ...
          <span><strong>Application rejected.</strong> {candidate.analysisError || 'The uploaded file was not a valid résumé/CV.'} No AI analysis was run. {canManage && 'If this is wrong, re-upload the correct file and re-run analysis.'}</span>
        </div>
      )}
